...
def attach_summaries(items, path):
    """Merge the generated ~100-word summaries onto the world stories.
    Keyed by 1-based position, matching how they were sent to the model."""
    if not path.exists():
        return
    try:
